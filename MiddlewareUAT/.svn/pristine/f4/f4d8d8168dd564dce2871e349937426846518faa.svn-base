...
final static String key = "0BEFE932733D76E69D08D597DF75D692";
//final static String key = "15EA4CA20131C2FD2315208C9110AD40";
final static int keySize =168;
...
public static void main(String[] args) {
	try {
		System.out.println(PinBlockEncryptionUtil.encryptPinBlock("6081940000093258", "147852"));
	...
	public static String encryptPinBlock(String cardNumber, String pin) throws NoSuchAlgorithmException,
