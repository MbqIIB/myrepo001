...
@XmlType(name = "", propOrder = { "head", "txn", "txnConfirmation" })
@XmlRootElement(name = "ReqTxnConfirmation")
public class ReqTxnConfirmation {
	 ...
	 *
	 * @return possible object is {@link TxnConfDtl }
	 */
	 ...
	 *
	 * @param value
	 *            allowed object is {@link TxnConfDtl }
	 */
