...
public class CustomeraccountHome {
	...
	public boolean deleteVpa(final String payeeaddr, final int regId) {
		try {
			...
			int updatedEntities = session.createSQLQuery(sqlUpdate)
					...
					.setInteger(ConstantI.REGID, regId).setDate("deleteddate", new Date()).executeUpdate();
			tx.commit();
			session.close();
	...
	public Customeraccount getActiveAccountByAccountAndVpaAndRegId(final String accrefnumber, final String regId,
		...
		try {
			...
			crAccDet.add(Restrictions.eq(ConstantI.REGID, Integer.parseInt(regId)));
	...
	public List<Customeraccount> getActiveListAccountByVPAAndRegVPAId(String vPA, Integer regVPAId) {
	...
	public List<String> getAllVPAForActiveAccount(String accRefNumber, String regId) {
		Session session = null;
	...
	public List<String> getActiveInactiveVPAForAccount(String accRefNumber, String regId) {
		Session session = null;
	...
	public List<Customeraccount> getAllVpas(int regid) {
		Session session = null;
	...
	public Customeraccount getDefAcc(Integer regid, String accvirtualid) {
		Session session = null;
	...
	public int getListAccountByRegVPAIdCount(Integer regVPAId) {
	...
	public List<Customeraccount> getListAccountByRegVPAId(Integer regVPAId) {
		log.trace("regVPAId:" + regVPAId);
		Session session = null;
		List<Customeraccount> listAccount = null;
		try {
	...
	public List<Customeraccount> getNonPrimaryAccVPA(String regId) {
		Session session = null;
	...
	public List<Customeraccount> getRecByMobileNo(String mobileNo, Integer integer, String vpa) {
		...
		try {
			...
			query.addEntity(Customeraccount.class);
			query.setParameter("mobileNo", mobileNo);
			query.setParameter("regid", integer);
	...
	public boolean setDefaultAccount(Customeraccount listaccount, Integer regid, String accvirtualid) {
		boolean flag = false;
		Session session = null;
		Transaction transaction = null;
		try {
	...
	public boolean updateAccount(String regId, String virtualId, String accRefNumber, String status) {
		Session session = null;
		try {
			session = this.sessionFactory.openSession();
	...
	// public List<Customeraccount> getRecByMobileNo(String mobileNo, Integer
	// integer) {
	//
	// Session session = null;
	// List<Customeraccount> results = new ArrayList<Customeraccount>();
	// try {
	// session = this.sessionFactory.openSession();
	// String sql = "select * from customeraccount where MOBILENO=:mobileNo and
	// REGID=:regid and STATUS= 1 and DEFACCOUNT=1";
	// SQLQuery query = session.createSQLQuery(sql);
	// query.addEntity(Customeraccount.class);
	// query.setParameter("mobileNo", mobileNo);
	// query.setParameter("regid", mobileNo);
	// results = query.list();
	// } catch (Exception e) {
	// StringWriter s;
	// e.printStackTrace(new PrintWriter(s = new StringWriter()));
	...
	public boolean updateVpa(String regId, String virtualId, String status) {
		Session session = null;
		boolean flag = false;
		try {
			session = this.sessionFactory.openSession();
	...
	public boolean updateNonPrimaryByCaidNotIn(Integer regId,Integer caid,Integer status) {
		Session session = null;
		boolean flag = false;
		try {
			session = this.sessionFactory.openSession();
	...
	public boolean updatePrimaryByCaidandReg(Integer caid,Integer regId) {
		Session session = null;
		boolean flag = false;
		try {
			session = this.sessionFactory.openSession();
