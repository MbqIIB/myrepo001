																																																																																																																														...
																																																																																																																														"FDB3"), MSGID_WRONG_LOGIN_PIN(
																																																																																																																																"REG26"), MSGID_WRONG_APP_VER(
																																																																																																																																		"MAS1"), MSGID_UPDT_DEV_IMEI_SUCCESS(
																																																																																																																																				"REG123"),MSGID_UPDT_DEV_IMEI_FAILURE("REG122"),NOT_VERIFY("QR01"),MANDATE_AMOUNT_MAX("MAM"),ALREADY_INITIATE_REQUEST("AIR01"),INVALID_REQUEST_ID("IR01"),INVALID_REQUEST("IR02");
