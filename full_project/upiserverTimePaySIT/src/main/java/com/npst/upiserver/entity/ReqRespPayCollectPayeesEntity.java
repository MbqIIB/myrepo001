...
@Entity
@Table(name = "reqresppaycollectpayees")
public class ReqRespPayCollectPayeesEntity implements java.io.Serializable {
	...
	@Column(name = "idReqRespPayCollect")
	public Long getIdReqRespPayCollect() {
		return idReqRespPayCollect;
	}
	...
	public String toString() {
		...
		builder.append("ReqresppaycollectPayees [");
		if (idpayeescol != null) {
