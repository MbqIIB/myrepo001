 ...
 *       &lt;sequence>
 *         &lt;element name="Version" type="{http://npci.org/upi/schema/}pspVersionType" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class PspVersionSupportedType {
    ...
    protected List<PspVersionType> version;
     ...
     * 
     */
    public List<PspVersionType> getVersion() {
        if (version == null) {
            version = new ArrayList<PspVersionType>();
        }
        return this.version;
    }
