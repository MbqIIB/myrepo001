...
public class CustomerMandateHistoryDto {

	private Long idMandates;
	private Long idReqRespMandate;	
	private Long regId;
	...
	private String mandateTxnType;
	public Long getIdMandates() {
		return idMandates;
	}
	public void setIdMandates(Long idMandates) {
		this.idMandates = idMandates;
	}
	public Long getIdReqRespMandate() {
		return idReqRespMandate;
	}
	public void setIdReqRespMandate(Long idReqRespMandate) {
		this.idReqRespMandate = idReqRespMandate;
	}
	...
	public String getMandateInitiatedBy() {
		return mandateInitiatedBy;
	}
	public void setMandateInitiatedBy(String mandateInitiatedBy) {
		this.mandateInitiatedBy = mandateInitiatedBy;
	}
	...
	public String getMandateTxnType() {
		return mandateTxnType;
	}
	public void setMandateTxnType(String mandateTxnType) {
		this.mandateTxnType = mandateTxnType;
	}
