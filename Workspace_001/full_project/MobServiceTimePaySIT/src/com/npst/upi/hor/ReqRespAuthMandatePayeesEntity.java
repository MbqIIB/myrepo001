...
@Entity
@Table(name = "REQ_RESP_AUTH_MANDATE_PAYEES")
public class ReqRespAuthMandatePayeesEntity implements Serializable {
	private static final long serialVersionUID = 1L;

	private Long idReqRespAuthMandatePayees;
	...
	@Column(name = "idReqRespAuthMandatePayees")
	public Long getIdReqRespAuthMandatePayees() {
		return this.idReqRespAuthMandatePayees;
	}

	@Column(name = "idReqRespAuthMandate", nullable = false)
	...
	public void setIdReqRespAuthMandatePayees(final Long idReqRespAuthMandatePayees) {
		this.idReqRespAuthMandatePayees = idReqRespAuthMandatePayees;
	}
	...
	public String toString() {
		...
		builder.append("ReqRespAuthMandatePayees [");
		if (idReqRespAuthMandatePayees != null) {
			builder.append("idReqRespAuthMandatePayees=").append(idReqRespAuthMandatePayees).append(", ");
		}
