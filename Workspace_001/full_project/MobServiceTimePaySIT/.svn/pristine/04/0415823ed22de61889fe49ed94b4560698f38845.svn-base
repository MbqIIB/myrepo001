...
public final class PasswordAuthentication {
	...
	// System.out.println(ft.format(new Date()));
	// System.out.println(PasswordAuthentication.hash("1234".toCharArray()));
	// System.out.println(PasswordAuthentication.hash("1234".toCharArray()));
	// System.out.println(ft.format(new Date()));
	// System.out.println(PasswordAuthentication.authenticate("1234".toCharArray(),
	// "$31$16$OFS9Of59T_9alHL84osu7RXy8jgFIrcCtV4B4paiEvk"));
	// System.out.println(ft.format(new Date()));
	// }
}
