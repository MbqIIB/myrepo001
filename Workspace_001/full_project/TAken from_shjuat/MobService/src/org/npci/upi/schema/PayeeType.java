...
@XmlType(name = "payeeType", propOrder = { "info", "device", "ac", "amount" })
public class PayeeType {
	 ...
	 *
	 * @param value
	 *            allowed object is {@link InfoType }
	 */
	 ...
	 *
	 * @param value
	 *            allowed object is {@link PayerConstant }
	 */
	...
	public String toString() {
		return "PayeeType [info=" + info + ", device=" + device + ", ac=" + ac + ", amount=" + amount + ", addr=" + addr
				+ ", name=" + name + ", seqNum=" + seqNum + ", type=" + type + ", code=" + code + "]";
	}
