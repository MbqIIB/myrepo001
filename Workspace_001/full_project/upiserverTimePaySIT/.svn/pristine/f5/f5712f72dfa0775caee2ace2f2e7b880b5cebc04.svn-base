...
@Entity
@Table(name = "reqrespsetcre")
public class ReqRespSetCre implements java.io.Serializable {
	
	private static final long	serialVersionUID	= 1L;
	private Long				idReqRespSetCre;
	...
	public ReqRespSetCre() {}
	
	public ReqRespSetCre(String txnId) {
		this.txnId = txnId;
	}
	
	public ReqRespSetCre(String reqHeadTs, String reqHeadOrgId, String reqHeadMsgId, String respHeadTs,
			...
			String acAddrTypeDetail3, String credsubType, String credtype, String respResult, String respErrCode,
			Date reqInsertDate, Date resInsertDate, String ackReq, String ackResp) {
	...
	@Column(name = "idReqRespSetCre", unique = true, nullable = false)
	public Long getIdReqRespSetCre() {
		return this.idReqRespSetCre;
	}
	...
	public void setIdReqRespSetCre(Long idReqRespSetCre) {
		this.idReqRespSetCre = idReqRespSetCre;
	}
	...
	public String toString() {
		...
		builder.append("Reqrespsetcre [");
		if (idReqRespSetCre != null) {
			builder.append("idReqRespSetCre=");
			builder.append(idReqRespSetCre);
			builder.append(", ");
		}
		if (reqHeadTs != null) {
