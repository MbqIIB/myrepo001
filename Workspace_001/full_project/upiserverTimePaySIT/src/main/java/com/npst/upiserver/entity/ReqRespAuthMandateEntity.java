...
@Entity
@Table(name = "REQ_RESP_AUTH_MANDATE")
public class ReqRespAuthMandateEntity implements Serializable {
	...
	@Column(name = "DeviceApp")
	public String getDeviceApp() {
		return deviceApp;
	}

	@Column(name = "DeviceCapability")
	public String getDeviceCapability() {
		return deviceCapability;
	}

	@Column(name = "DeviceGeocode")
	...
	@Column(name = "idReqRespAuthMandate")
	...
	public void setIdReqRespAuthMandate(final Long idReqRespAuthMandate) {
	...
	public void setRespAuthAck(final String respAuthAck) {
	...
	public void setTxnConfAck(final String txnConfAck) {
		this.txnConfAck = txnConfAck;
	}

	public void setTxnConfOrgErrCode(final String txnConfOrgErrCode) {
		this.txnConfOrgErrCode = txnConfOrgErrCode;
	}

	public void setTxnConfOrgStatus(final String txnConfOrgStatus) {
	...
	public String toString() {
		...
		builder.append("ReqRespAuthMandate [");
		if (idReqRespAuthMandate != null) {
			builder.append("idReqRespAuthMandate=").append(idReqRespAuthMandate).append(", ");
		}
		if (regid != null) {
		...
		if (respAuthAck != null) {
			builder.append("respAuthAck=").append(respAuthAck).append(", ");
		}
		if (txnConfOrgErrCode != null) {
			builder.append("txnConfOrgErrCode=").append(txnConfOrgErrCode).append(", ");
		}
		if (txnConfOrgStatus != null) {
			builder.append("txnConfOrgStatus=").append(txnConfOrgStatus).append(", ");
		}
		...
		if (txnConfAck != null) {
			builder.append("txnConfAck=").append(txnConfAck).append(", ");
		}
		if (payerHandal != null) {
