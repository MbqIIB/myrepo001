...
public class CBSPackager extends ISOBasePackager
{
	protected ISOFieldPackager fld[] = {
		    ...
		    /*011*/ new IFA_NUMERIC (  12, "Systems trace audit number"),
		    /*012*/ new IFA_NUMERIC ( 14, "Date and time, Local transaction"),
		    ...
		    /*017*/ new IFA_NUMERIC (  8, "Date, Capture"),
		    ...
		    /*102*/ new IFA_LLCHAR  ( 60, "Account identification 1"),
		    /*103*/ new IFA_LLCHAR  ( 60, "Account identification 2"),
